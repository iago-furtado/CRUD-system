...
if(isset($_GET['editId']) && !empty($_GET['editId'])) {
  $editId = $_GET['editId'];
  $customer = $portfolioOjb->displyaRecordById($editId);
}

// Update Record in customer table
if(isset($_POST['update'])) {
  $portfolioOjb->updateRecord($_POST);
}
            ...
            <section class="form">
                ...
                <form action="add.php" method="POST">
                    ...
                    <label for="qtt">Quantity: </label>
                        <input type="text" class="form-control" name="qtt">
                    <!-- Price -->
                    <label for="price">Price: </label>
                        <input type="text" class="form-control" name="price">
                    <br>
                    <!-- Submit -->
                    <input class="btn" type="submit" class="btn btn-primary" name="submit" value="Submit">
                    <input class="btn" type="reset" class="btn btn-primary" name="reset" value="Reset">
                </form>
            </section>
        </main>
         <!-- Footer -->
